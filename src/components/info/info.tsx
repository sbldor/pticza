  ...
  return (
    <div className={style.cont}>
      ...
      <div className={style.text}>
        ...
        <p className={style.subtitle}>
          Сложные световые схемы и цветной свет для меня не проблема: они делают
          снимки более интересными и красочными. У меня есть навык съёмки как на
          улице, так и в студии. Я обожаю фото-искусство и развиваюсь во всех
          его жанрах.
        </p>
        <ul>
